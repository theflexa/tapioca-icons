...
const VISUAL_STYLES: Record<VisualStyle, string> = {
  ...
  "pixel-8bit": [
    "pixel art icon rendered on a 16x16 pixel grid",
    "8-bit retro game style",
    "very large chunky square pixels clearly visible",
    "extremely limited color palette maximum 8 colors",
    "no anti-aliasing no gradients",
    "NES Gameboy era aesthetic",
    "simple blocky geometric shapes",
    "each pixel is a distinct solid color square",
    "single centered object",
    "plain white background",
  ].join(", "),
  "pixel-16bit": [
    "pixel art icon rendered on a 32x32 pixel grid",
    "16-bit retro game style",
    "crisp sharp square pixels clearly visible",
    "limited color palette maximum 24 colors",
    "no anti-aliasing hard pixel edges",
    "SNES Sega Genesis era aesthetic",
    "isometric pixel art view",
    "bright saturated flat colors",
    "single centered object",
    "plain white background",
  ].join(", "),
  "pixel-32bit": [
    "pixel art icon rendered on a 64x64 pixel grid",
    "32-bit pixel art style",
    "detailed pixel rendering with visible pixel grid",
    "rich color palette with dithering shading",
    "PS1 GBA era aesthetic",
    "isometric detailed pixel view",
